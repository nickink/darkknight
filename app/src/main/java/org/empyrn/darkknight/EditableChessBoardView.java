 ...
 * @author petero
 */
public class EditableChessBoardView extends ChessBoardView {
	private final static int gap = 2;

	public EditableChessBoardView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
